...
URL. Your job: _look_ at real screens across devices, exercise edge cases, and produce a report a
...
2. Judge every surface at **three viewports**: **mobile 375×812**, **tablet 768×1024**, **desktop
   ...
   inline action↔FAB. Breaks _at_ the boundary are common defects.
...
Judge the _experience_: "it renders" is not the bar — "is this good UX on a phone with real, ugly data?" is.
...
- **<surface> @ <viewport(s)>** — <what's wrong, observed> · _Why it hurts:_ <reason> · _Fix:_
